# 5374 奈良県生駒市版
## 2025.3.28 2025年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2025年度のデータにアップデートしました。
Takuya Sato

## 2024.4.9 2024年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2024年度のデータにアップデートしました。
Takuya Sato

## 2023.3.26 2023年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2023年度のデータにアップデートしました。
Takuya Sato

## 2022.5.23 2022年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2022年度のデータにアップデートしました。

## 2021.3.29 2021年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2021年度のデータにアップデートしました。

## 2020.3.10 2020年度ごみ収集日程アップデート

CODE for IKOMAの有志により、2020年度のデータにアップデートしました。
ゴミ収集日の不規則性への対応のため、全収集日を日付形式でデータにしました。（area_days.csv）

## 2019.3.16 平成31年度ごみ収集日程アップデート

CODE for IKOMAの有志により、平成31年度のデータにアップデートしました。
Takao Ikoma
Yoshinori Nishikawa
Takuya Sato
